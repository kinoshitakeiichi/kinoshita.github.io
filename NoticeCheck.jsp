		          ...
		          <!-- 此处插入页面代码 -->
		          	<table border="1px">
		          		<tr>
		          			...
		          			<td width="500"><s:property value="nobean.title"/></td>
		          		</tr>
		          		<tr>
		          			<td width="100" style="text-align:center;">发布者</td>
		          			<td width="500"><s:property value="nobean.author"/></td>
		          		</tr>
		          		<tr>
		          			<td width="100" style="text-align:center;">内容</td>
		          			<td width="500"><s:property value="nobean.content"/></td>
		          		</tr>
		          		<tr>
		          			<td width="100" style="text-align:center;">发布时间</td>
		          			<td width="500"><s:property value="nobean.re_data"/></td>
		          		</tr>
		          	</table>
